...
## 3) Merging Deep Learning with Statistical and Causal Models: 
While deep learning is exceptional in identifying complex patterns, statistical and causal models offer superior interpretability and the ability to reason about interventions. Our research aims to merge these worlds, creating models that are both powerful and understandable, enabling better decisions under uncertainty. This approach is evident in most of our published works, where we seamlessly integrate deep learning with statistical and causal insights to support informed decision-making.

## 4) Agentic AI with Causal and Statistical Reasoning (Upcoming Direction):
As AI systems become increasingly agentic, a critical research gap emerges: agentic systems, like standard deep learning models, lack inherent causal understanding. They can predict patterns but cannot reliably reason about the consequences of their interventions. We are currently exploring how to integrate causal and statistical reasoning into agentic AI workflows, enabling agents to not only predict outcomes but understand *why* things happen and *how to intervene* robustly. This extends our fusion of deep learning and statistical-causal models into the decision-making and planning space, creating agents that are both powerful and interpretable.
